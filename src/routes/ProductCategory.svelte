<div class="bg-gray-100 py-16">
	<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
		<h2 class="text-3xl font-extrabold text-gray-900 text-center mb-8">Categorías</h2>
		<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
			<div class="bg-white rounded-lg overflow-hidden shadow-lg">
				...
				/>
				<div class="p-4">
					<h3 class="text-lg font-medium text-gray-800">Maquillaje</h3>
					<a href="#" class="text-sm text-blue-500 hover:text-blue-700">Ver productos</a>
				</div>
			</div>
			<div class="bg-white rounded-lg overflow-hidden shadow-lg">
				<img
				...
				/>
				<div class="p-4">
					<h3 class="text-lg font-medium text-gray-800">Cuidado de la piel</h3>
					<a href="#" class="text-sm text-blue-500 hover:text-blue-700">Ver productos</a>
				</div>
			</div>
			<div class="bg-white rounded-lg overflow-hidden shadow-lg">
				...
				/>
				<div class="p-4">
					<h3 class="text-lg font-medium text-gray-800">Accesorios</h3>
					<a href="#" class="text-sm text-blue-500 hover:text-blue-700">Ver productos</a>
				</div>
			</div>
			<div class="bg-white rounded-lg overflow-hidden shadow-lg">
				...
				/>
				<div class="p-4">
					<h3 class="text-lg font-medium text-gray-800">Ropa</h3>
					<a href="#" class="text-sm text-blue-500 hover:text-blue-700">Ver productos</a>
				</div>
			</div>
		</div>
